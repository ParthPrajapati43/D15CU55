...
import 'package:d15cu55/presentation/pages/widget/message_layout.dart';
import 'package:intl/intl.dart';
import 'package:responsive_builder/responsive_builder.dart';

class SingleChatPageTablet extends StatefulWidget {
  final String uid;
  final String userName;

  const SingleChatPageTablet({Key key, this.uid, this.userName})
      : super(key: key);

  @override
  _SingleChatPageTabletState createState() => _SingleChatPageTabletState();
}

class _SingleChatPageTabletState extends State<SingleChatPageTablet> {
